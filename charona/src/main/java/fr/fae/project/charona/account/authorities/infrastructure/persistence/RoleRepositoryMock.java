package fr.fae.project.charona.account.authorities.infrastructure.persistence;

import fr.fae.project.charona.account.authorities.domain.models.Role;
import fr.fae.project.charona.account.authorities.domain.ports.IRoleRepository;
